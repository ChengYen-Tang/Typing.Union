...
namespace Type
{
    public abstract class Union<T1, T2, T3, T4, T5, T6, T7, T8>
    {
        ...
        public static explicit operator Union<T1, T2, T3, T4, T5, T6, T7, T8>(T1 value)
            => new Case1(value);
        public static explicit operator Union<T1, T2, T3, T4, T5, T6, T7, T8>(T2 value)
            => new Case2(value);
        public static explicit operator Union<T1, T2, T3, T4, T5, T6, T7, T8>(T3 value)
            => new Case3(value);
        public static explicit operator Union<T1, T2, T3, T4, T5, T6, T7, T8>(T4 value)
            => new Case4(value);
        public static explicit operator Union<T1, T2, T3, T4, T5, T6, T7, T8>(T5 value)
            => new Case5(value);
        public static explicit operator Union<T1, T2, T3, T4, T5, T6, T7, T8>(T6 value)
            => new Case6(value);
        public static explicit operator Union<T1, T2, T3, T4, T5, T6, T7, T8>(T7 value)
            => new Case7(value);
        public static explicit operator Union<T1, T2, T3, T4, T5, T6, T7, T8>(T8 value)
            => new Case8(value);
